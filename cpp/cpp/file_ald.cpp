...
void File_ald::saveNewAld(std::wstring newNameOSC) {
	try {
		...
		if (dot_pos == std::string::npos) {
			this->m_logger->logging(LogLevel::_ERROR_, "������������ ��� ����� (��� ����������)");
			return;
		}
		...
		if (!newAld.is_open()) {
			this->m_logger->logging(LogLevel::_ERROR_, "�� ������� ������� ����: " + wstring_to_ansi(newFileNameAld));
			return;
		}
		...
		// ���������� ��������� ������ � �������� ����� �� ������ ��������
		this->file->clear();  // ����� ������ ����� seekg()
		this->file->seekg(seek, std::ios::beg);  // seek - ���� ����������� ��������
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		UINT*	readBuffer = new UINT[READ_BUF_SIZE + MAX_DATA_SIZE];
		if (!readBuffer) {
			return FALSE;
		}
		...
		while (true) {
			//this->m_logger->logging(LogLevel::_INFO_, "in start stay_count: " + std::to_string(stay_count));
			words_read = ReadDataIntoBuffer(readBuffer, stay_count);
			//this->m_logger->logging(LogLevel::_INFO_, "in start words_read: " + std::to_string(words_read));
			if (!words_read) break;
...
size_t File_ald::ReadDataIntoBuffer(UINT* readBuffer, const size_t stay�ount)
{
	// �������� ����������
	...
	// ������ ������ �� �����
	this->file->read(reinterpret_cast<char*>(readBuffer + stay�ount), bytesToRead);
