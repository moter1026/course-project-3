...
typedef struct TAG_NEW_PARAM	//29.11.00L //10.10.18S
{
	...
	CListCtrl *	list;
	BOOL		asc_sort;		//TRUE - сортировка в пор€дке возрастани€; //05.01.01L
}NEW_PARAM;
...
#define D_VALUE			10				//величина размера €чейки решЄтки по умолчанию [мм]				//29.03.06S
#define MAXZONE			10000			//максимальный размер п€тна в локации по умолчанию				//29.03.06S
#define MINTOTNUM		3				//минимально допустимый размер пачки дл€ локации по умолчанию	//29.03.06S
...
#define LANGUAGE_VERSION 000000			//верси€ €зыка (000000-русский, 100000 - английский, 200000 - польский) //19.10.15S
